...
<div class="row">
    <div class="col-lg-12">
        <div class="card-box">
            ...
            <form action="{{ route('vendors.profiles.update') }}" class="ajaxForm" method="post" enctype="multipart/form-data" novalidate id="form">
                @csrf

                <div class="row">
                    <div class="col-md-6">
                        <label for="">Company Name</label>
                        <input type="text" class="form-control" value="{{ @$edit_profile->company_name }}" name="company_name" id="company_name" required>
                    </div>
                    <div class="col-md-6">
                        <label for="">Contact Person Name</label>
                        <input type="text" class="form-control" value="{{ @$edit_profile->contact_person_name }}" name="contact_person_name" id="contact_person_name" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <label for="">Contact No</label>
                        <input type="text" class="form-control" value="{{ @$edit_profile->contact_no }}" name="contact_no" id="contact_no" required>
                    </div>
                    <div class="col-md-6">
                        <label for="">Email</label>
                        <input type="email" class="form-control" value="{{ @$edit_profile->email }}" disabled name="email" id="email" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
