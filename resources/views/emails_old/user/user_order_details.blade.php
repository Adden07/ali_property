																											...
																											<tbody>
																												<tr>
																													<td style="font-family: Helvetica, Arial, sans-serif; font-weight:normal; font-size:18px; line-height:28px; letter-spacing: 1px; text-transform: uppercase;"
																														...
																														data-max="50"
																														align="left">
																														<img src="https://hometalab.com/front_assets/img/logo/logo-2.png" style="width: 200px"
																															width="200" />
																													</td>
																												</tr>
																												<!-- End Content -->
												...
												<tr>
													<td align="center">
														<table width="100%" cellspacing="0" cellpadding="0" border="0"
															...
															<tbody>
																<tr>
																	<td class="stack-column" width="200" valign="top"
																		align="left">
																		<table style="width: 200px;"
																			class="email-container" width="200"
																				...
																				<tr>
																					<td style="padding: 0px;"
																						...
																						<table width="100%"
																							...
																							<tbody>
																								<tr>
																									<td style="font-family: Helvetica, Arial, sans-serif; font-weight:normal; color: #000; font-size:18px; line-height:28px; letter-spacing: 1px; text-transform: uppercase;"
																										class="center_text"
																										data-min="3"
																										data-max="50"
																										align="left">
																	...
																	<td class="stack-column" width="200" valign="top"
																		align="left">
																		<table style="width: 200px;"
																			class="email-container" width="220"
																			cellspacing="0" cellpadding="0" border="0"
																			align="right">
																			<tbody>
																				<tr>
																										...
																										<table
																											...
																											<tbody>
																												<tr
																													align="left">
																													<td
																														style="font-family: Helvetica, Arial, sans-serif; font-weight:normal; color:#000; font-size:18px; line-height:28px; letter-spacing: 1px; text-transform: uppercase;">
																														<h4
																															style="color: #2E3192">
																															Order
																															Numbers
																											...
																											<tbody>
																												<tr>
																													<td align="right"
																														...
																														<p
																															style="color: #000000; font-size: 15px; line-height: 28px;">
																															{{ $service->service_name }} <br>
																															{{ implode(", ", $order->orderDetails->pluck('package_name')->toArray()) }} <br>
																															{{-- Cheif Complaint --}}
																														</p>
																													</td>
																												</tr>
								...
								<tr>
									<td>
										<table width="100%" cellspacing="0" cellpadding="5" border="0" class=""
											align="left" style="color: #000;">
											<thead>
												<tr style="border-bottom: 3px solid #F7931E;">
													<th align="left">Package</th>
													<th align="left">Price</th>
													<th align="left">Persons</th>
													@if($service->is_professional)
														<th align="left">Professionals</th>
													@endif
											...
											<tbody>
												...
												<tr style="border-bottom: 1px solid #E7E7E7">
													...
													<td>{{ $detail->pkg_price }}</td>
													<td>{{ $detail->persons }}</td>
													@if(!is_null($detail->no_of_professionals))
														<td>{{ $detail->no_of_professionals }}</td>
													@endif
											...
											<tbody>
												<tr>
													...
													<td align="right" width="150"
														style="color: #000; border-bottom: 2px solid #F7931E; font-weight: bold;">
														Subtotal
													</td>
													<td align="right" width="200"
														style="color: #000; border-bottom: 2px solid #F7931E; color: #000; font-weight: bold;">
														AED {{ $order->net_total }}</td>
												</tr>

												<tr>
													<td colspan="2"></td>
													<td align="right"
														style="border-bottom: 2px solid #F7931E; font-weight: bold; color: #000; ">
														Discount
													</td>
													<td align="right"
														style="border-bottom: 2px solid #F7931E;  color: #000; font-weight: bold;">
														AED {{ $order->discount }}</td>
												</tr>
												...
												<tr>
													...
													<td align="right" style=" font-weight: bold; color: #000;">AED {{ $order->total }}
													</td>
												</tr>
