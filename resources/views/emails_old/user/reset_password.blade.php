					...
					<div style="max-width:700px; border-left: 2px solid #F7931E; border-right: 2px solid #F7931E; margin: 0 auto;">
						<table style="width: 100%;">
							<div style="width: 100%; text-align: center;">
								...
								<h3 style="color: #000;">Click here to reset your password (this link will expire after 10 minutes)</h3>
								<h1 style="color: #2e3192; margin-bottom: 20px; margin-top: 20px; letter-spacing: 5px; font-size: 35px;"><a href="{{ $url }}">Click Here</a></h1>
							</div>
